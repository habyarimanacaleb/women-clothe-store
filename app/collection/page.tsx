  ...
  return (
    <div className="container mx-auto px-4 pt-36 pb-8">
      ...
      {filteredProducts.length === 0 ? (
        ...
        <button onClick={()=> useRouter().push("/")} className="flex items-center border cursor-pointer border-gray-400 py-2 px-3 rounded-lg hover:bg-purple-500 hover:text-white transition duration-500 ease-in-out">
